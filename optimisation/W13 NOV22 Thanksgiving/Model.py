...
M1 = LpVariable("M1", None, None, cat = 'Binary')
M2 = LpVariable("M2", None, None, cat = 'Binary')
M3 = LpVariable("M3", None, None, cat = 'Binary')
M4 = LpVariable("M4", None, None, cat = 'Binary')
M5 = LpVariable("M5", None, None, cat = 'Binary')
W1 = LpVariable("W1", None, None, cat = 'Binary')
W2 = LpVariable("W2", None, None, cat = 'Binary')
W3 = LpVariable("W3", None, None, cat = 'Binary')
...
prob += Y11 + Y12 + Y13 + Y14 <= 900*W1
prob += Y21 + Y22 + Y23 + Y24 <= 900*W2
prob += Y31 + Y32 + Y33 + Y34 <= 900*W3
